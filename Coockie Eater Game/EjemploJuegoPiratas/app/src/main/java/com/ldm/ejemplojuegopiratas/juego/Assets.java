...
public class Assets {
    ...
    public static Pixmap botin4;
    public static Pixmap muro;
    public static Pixmap comiendoaariba;
    public static Pixmap comiendoabajo;
    public static Pixmap comiendoderecha;
    public static Pixmap comiendoizquierda;

    public static Sonido pulsar;
    public static Sonido ataque;
    public static Sonido derrota;
    public static Sonido veneno;
